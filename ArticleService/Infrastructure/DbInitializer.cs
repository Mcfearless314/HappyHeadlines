...
public class DbInitializer
{
    ...
    public void Initialize()
    {
        var sampleArticles = new List<Article>
        {
            ...
            new Article
            {
                Id = 2, Title = "Caching Tips", Content = "How to use caches effectively.",
                PublishDate = DateTime.Today.AddDays(-3)
            },
            new Article
            {
                Id = 3, Title = "Grafana Dashboards", Content = "Visualizing metrics easily.",
            ...
            new Article
            {
                Id = 4, Title = "Old Article 1", Content = "This article is older than 14 days.",
                PublishDate = DateTime.Today.AddDays(-20)
            },
            new Article
            {
                Id = 5, Title = "Old Article 2", Content = "Another old article.",
                PublishDate = DateTime.Today.AddDays(-30)
            },
            new Article
            {
                Id = 6, Title = "Old Article 3", Content = "Yet another old article.",
        ...
        CREATE TABLE Articles(Id INT PRIMARY KEY, Title NVARCHAR(50), Content NVARCHAR(200), PublishDate DATETIME NOT NULL)";
        ...
        foreach (var article in sampleArticles)
        {
            ...
            insertCommand.CommandText =
                "INSERT INTO Articles (Id, Title, Content, PublishDate) VALUES (@id, @title, @content, @publishDate)";
            var idParam = insertCommand.CreateParameter();
            idParam.ParameterName = "@id";
            idParam.Value = article.Id;
